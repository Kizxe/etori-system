  ...
  if (isLoading) {
    return (
      <div className="container mx-auto p-6">
        <h1 className="text-2xl font-bold mb-6">Approve Request</h1>
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold">Approve Request</h1>
        <p className="text-muted-foreground">Approve the stock request from {request.requestedBy?.name || 'Unknown'}</p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="pt-4">
            <h3 className="text-sm font-medium text-muted-foreground mb-2">Approval Notes (Optional)</h3>
            <Textarea
